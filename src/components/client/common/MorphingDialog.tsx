...
// for more info, check: https://motion-primitives.com/docs/morphing-dialog
      ...
      {isOpen && (
        <>
          <motion.div
            ...
            className="fixed inset-0 z-30 h-full w-full bg-white/40 backdrop-blur-sm dark:bg-black/40"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          />
