...
export function HeaderLink({ number, text, className }: HeaderLinkProps) {
  return (
    <Link href={`#${text}`} className={cn("group flex flex-col items-center gap-2 lg:items-end lg:gap-0", className)}>
